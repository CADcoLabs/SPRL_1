    ...
    def _create_sector_tread(
        ...
        try:
            ...
            if is_mock:
                ...
                # Create arc to represent the tread
                ...
                # Measurements removed to prevent unwanted dimensions/text in AutoCAD
                # self._add_tread_measurements(autocad_interface, start_angle, end_angle, inner_radius, outer_radius, tread_height)
                ...
                try:
                    ...
                    if regions and len(regions) > 0:
                        ...
                        print(
                            f"AutoCAD: Created 3D solid sector tread from {math.degrees(start_angle):.1f}° to {math.degrees(end_angle):.1f}° at Z={tread_height:.2f}"
                        )
                        ...
                        print(f"Failed to create region for tread at Z={tread_height}")
                        return False
                    
                except Exception as e:
                    print(f"Error creating 3D solid sector tread in AutoCAD: {str(e)}")
                    return False
